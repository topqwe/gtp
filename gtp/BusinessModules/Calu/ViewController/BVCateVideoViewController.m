...
@interface BVCateVideoViewController ()
@property(nonatomic, strong) NSMutableArray                     *dataSouce;/**< <##> */
@property(nonatomic, strong) STNoresultView                     *noresuletView;/**< <##> */
@end

@implementation BVCateVideoViewController
...
- (void)configFooterView{
    ...
    CGFloat menuWith = UIScreenWidth / 2;
    CGFloat menuheight = menuWith * 0.8  ;
    for (NSInteger i = 0; i < array.count; i ++) {
        ...
        menu.left = i%2 * menuWith;
        menu.top = i/2 * menuheight + 5;
