...
//    self.tagView3.selected = YES;
    ...
    self.tagView3.tagSelectedBorderColor = [UIColor clearColor];
    self.tagView3.tagSelectedBackgroundColor = [UIColor redColor];
    
    self.tagView3.tagBorderColor = [UIColor clearColor];
    self.tagView3.tagBackgroundColor = [UIColor clearColor];
    ...
    self.tagView1.defaultSelectTags = @[self.tagView1.tagsArray.firstObject];
    ...
    self.tagView2.defaultSelectTags = @[self.tagView2.tagsArray.firstObject,self.tagView2.tagsArray.lastObject];
    
    self.tagView3.tagsArray = @[@{@"name":@"林俊杰twefvewggvervrevevewewjntj5tjytjy",@"id":@(9)},@"张学友4tjtjtyj",@"刘德华",@"陶喆",@"王力宏",@"王菲",@"Taylor swift",@"周杰伦",@"owl city",@"汪苏泷",@"许嵩",@"李代沫",@"那英",@"羽泉",@"刀郎",@"田馥甄",@"庄心妍",@"林宥嘉",@"薛之谦",@"萧敬腾",@"王若琳"];
    self.tagView3.defaultSelectTags = @[self.tagView3.tagsArray.firstObject];
...
//    [self.tagView3 removeTag:[self.tagView3.tagsArray objectAtIndex:r3]];
    [self.tagView1 removeTag:[self.tagView1.tagsArray objectAtIndex:1]];
    [self.tagView2 removeTag:[self.tagView2.tagsArray objectAtIndex:1]];
    [self.tagView3 removeTag:[self.tagView3.tagsArray objectAtIndex:1]];
}
