...
- (void)updateTextViewFrame {
    CGFloat textViewHeight = _keyboardHeight > YBFrameTool.iphoneBottomHeight ? _textHeight + 2*kHoverTextViewTopBottomInset : ceilf(_textView.font.lineHeight) + 2*kHoverTextViewTopBottomInset;
...
- (void)updateRightViewsFrame {
    ...
    originX -= _keyboardHeight > YBFrameTool.iphoneBottomHeight ? 50 : (_textView.text.length > 0 ? 50 : 0);
...
- (void)updateIconState {
    _editImageView.image = _keyboardHeight > YBFrameTool.iphoneBottomHeight ? [UIImage imageNamed:@"ic90Pen1"] : (_textView.text.length > 0 ? [UIImage imageNamed:@"ic90Pen1"] : [UIImage imageNamed:@"ic30Pen1"]);
    _atImageView.image = _keyboardHeight > YBFrameTool.iphoneBottomHeight ? [UIImage imageNamed:@"ic90WhiteAt"] : (_textView.text.length > 0 ? [UIImage imageNamed:@"ic90WhiteAt"] : [UIImage imageNamed:@"ic30WhiteAt"]);
...
- (void)keyboardWillShow:(NSNotification *)notification {
    self.backgroundColor = RGBA(0.0, 0.0, 0.0, 0.4);
    //获取当前软键盘高度
