...
@interface AnnouncePopUpCell : UITableViewCell
...
@implementation AnnouncePopUpCell
...
+(instancetype)cellWith:(UITableView*)tabelView{
    AnnouncePopUpCell *cell = (AnnouncePopUpCell *)[tabelView dequeueReusableCellWithIdentifier:@"AnnouncePopUpCell"];
    if (!cell) {
        cell = [[AnnouncePopUpCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"AnnouncePopUpCell"];
    }
    return cell;
}
...
@interface AnnouncePopUpView()<UIGestureRecognizerDelegate,UITableViewDelegate, UITableViewDataSource>
...
@implementation AnnouncePopUpView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    AnnouncePopUpCell *cell = [AnnouncePopUpCell cellWith:tableView];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return [AnnouncePopUpCell cellHeightWithModel:(_sections[indexPath.section])[indexPath.row]];
}
