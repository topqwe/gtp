...
-(void)layoutSubviews {
    ...
    //[MD5_UDID isEqualToString:_chat.visitor.udid]
    if([[UserInfoManager GetNSUserDefaults].data.ID isEqualToString:_chat.user_id]){
        ...
        _backgroundlayer.fillColor = YBGeneralColor.themeColor.CGColor;
...
+ (NSDictionary* ) attributes {
    return @{NSFontAttributeName:[UIFont systemFontOfSize:16.0],NSForegroundColorAttributeName:[UIColor blackColor]};
}
