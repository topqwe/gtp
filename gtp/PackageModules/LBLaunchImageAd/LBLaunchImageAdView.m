...
- (void)addLBlaunchImageAdView:(AdType)adType{
    ...
    self.frame = CGRectMake(0, 0, mainWidth, mainHeight);//kGETVALUE_HEIGHT(750, 1334, MAINSCREEN_WIDTH- 0)
    //kGETVALUE_HEIGHT(1334, 750, MAINSCREEN_HEIGHT- 0)
    if (adType == FullScreenAdType) {
        self.aDImgView = [[FLAnimatedImageView alloc]initWithFrame:CGRectMake(0, 0, mainWidth, mainHeight)];
//        self.aDImgView = [[FLAnimatedImageView alloc]initWithFrame:CGRectMake(-(kGETVALUE_HEIGHT(1334, 750, MAINSCREEN_HEIGHT- 0)-mainWidth)/2, 0 , kGETVALUE_HEIGHT(1334, 750, MAINSCREEN_HEIGHT- 0), mainHeight)];//固高
        
//        self.aDImgView = [[FLAnimatedImageView alloc]initWithFrame:CGRectMake(0, (mainHeight-kGETVALUE_HEIGHT(750, 1334, MAINSCREEN_WIDTH- 0))/2 , mainWidth, kGETVALUE_HEIGHT(750, 1334, MAINSCREEN_WIDTH- 0))];//mainWidth 固宽
    }else{
