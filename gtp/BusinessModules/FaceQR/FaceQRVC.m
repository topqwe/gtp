...
@interface FaceQRVC ()<UITableViewDelegate,UITableViewDataSource>
@property (strong , nonatomic) NSArray *dataArray;
@property (strong , nonatomic) UITableView *tableView;
@end

@implementation FaceQRVC
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    label.backgroundColor = [YBGeneralColor themeColor];
    NSString *title = nil;
    switch (section) {
        case 0:
        {
