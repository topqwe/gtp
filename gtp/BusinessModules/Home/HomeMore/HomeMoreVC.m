...
@interface HomeMoreVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation HomeMoreVC

#pragma mark - life cycle
+ (instancetype)pushFromVC:(UIViewController *)rootVC requestParams:(id )requestParams success:(DataBlock)block{
    HomeMoreVC *vc = [[HomeMoreVC alloc] init];
//    vc.block = block;
...
- (void) requestHomeListWithPage:(NSInteger)page WithCid:(NSInteger)cid{
   kWeakSelf(self);
    self.cid = cid;
    [self.vm network_postHomeMoreWithPage:page WithCid:cid success:^(NSArray * _Nonnull dataArray, NSArray * _Nonnull lastSectionArr,NSArray * _Nonnull lastSectionSumArr) {
        kStrongSelf(self);
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (type) {
        ...
        case IndexSectionOne:
            return [MoreGridCell cellHeightWithModel:itemData];
            break;
