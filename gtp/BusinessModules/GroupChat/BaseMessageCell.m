...
+ (NSDictionary* )attributes {
    return @{NSFontAttributeName:[UIFont systemFontOfSize:12.0],NSForegroundColorAttributeName:[UIColor grayColor]};
}

//NSString转NSMutableAttributedString
+ (NSMutableAttributedString *)cellAttributedString:(GroupChat *)chat {
    NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc] initWithString:(chat.msg_content&&chat.msg_content.length>0)?chat.msg_content:chat.content];
