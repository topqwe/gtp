...
- (void)setModel:(id)model
{
    ...
    if ([model isKindOfClass:[HomeItem class]]) {
        HomeItem* item = model;
...
- (void)removeTag:(id)model
{
    ...
    for (TTTagItem *item in self.scrollView.subviews) {
        ...
        if ([item.model isKindOfClass:[NSDictionary class]] &&
            [model isKindOfClass:[NSDictionary class]]&&
            [item.model isEqualToDictionary:model]) {
            [self.selectBtns removeObject:item];
            self.selectTags = [self.selectBtns valueForKeyPath:@"model"];
            _tagsArray = [self.scrollView.subviews valueForKeyPath:@"model"];
            [item removeFromSuperview];
        ...
        if ([item.model isKindOfClass:[HomeItem class]] &&
            [model isKindOfClass:[HomeItem class]]&&
            [item.model isEqual:model]) {
            [self.selectBtns removeObject:item];
            self.selectTags = [self.selectBtns valueForKeyPath:@"model"];
            _tagsArray = [self.scrollView.subviews valueForKeyPath:@"model"];
            [item removeFromSuperview];
