...
@interface MineClearVC ()<UIPopoverPresentationControllerDelegate,PopViewControllerDelegate>
/**
 *  用户选择的点击方式
 */
...
- (void)winGame {
    ...
    if (array.count < 5 || (array.count >= 5 && ((UserModel *)array.lastObject).time > self.timeInterval)) {
        ...
        __weak MineClearVC *weakSelf = self;
