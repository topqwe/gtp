...
- (instancetype)init {
    ...
    if (self) {
        ...
        _container = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight, ScreenWidth, 280 + YBFrameTool.iphoneBottomHeight)];
        ...
        _cancel = [[UIButton alloc] initWithFrame:CGRectMake(0, 230, ScreenWidth, 50 + YBFrameTool.iphoneBottomHeight)];
        [_cancel setTitleEdgeInsets:UIEdgeInsetsMake(-YBFrameTool.iphoneBottomHeight, 0, 0, 0)];
