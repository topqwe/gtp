...
- (void) initAvatarBackground {
    _topBackground = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, 50 + [YBFrameTool safeAdjustNavigationBarHeight])];
    _topBackground.contentMode = UIViewContentModeScaleAspectFill;
    [self addSubview:_topBackground];
    
    _bottomBackground = [[UIImageView alloc] initWithFrame:CGRectMake(0, 35 + [YBFrameTool safeAdjustNavigationBarHeight], ScreenWidth, self.bounds.size.height - (35 + [YBFrameTool safeAdjustNavigationBarHeight]))];
...
-(UIBezierPath *)createBezierPath {
    ...
    [bezierPath addLineToPoint:CGPointMake(ScreenWidth, self.bounds.size.height - (50 + [YBFrameTool safeAdjustNavigationBarHeight]) + topOffset - 1)];
    [bezierPath addLineToPoint:CGPointMake(0, self.bounds.size.height - (50 + [YBFrameTool safeAdjustNavigationBarHeight]) + topOffset - 1)];
...
- (void) initAvatar {
    ...
    [_avatar mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self).offset(40 + [YBFrameTool safeAdjustNavigationBarHeight]);
...
- (void) initActionsView {
    ...
    _settingIcon.layer.backgroundColor = RGBA(255.0, 255.0, 255.0, 0.2).CGColor;
    ...
    _focusIcon.layer.backgroundColor = RGBA(255.0, 255.0, 255.0, 0.2).CGColor;
    ...
    _sendMessage.textColor = RGBA(255.0, 255.0, 255.0, 0.6);
    _sendMessage.textAlignment = NSTextAlignmentCenter;
    _sendMessage.font = [UIFont systemFontOfSize:14.0];
    _sendMessage.hidden = !_isFollowed;
    _sendMessage.layer.backgroundColor = RGBA(255.0, 255.0, 255.0, 0.2).CGColor;
    ...
    _focusButton.layer.backgroundColor = YBGeneralColor.themeColor.CGColor;
...
- (void)initInfoView {
    ...
    _nickName.font = [UIFont boldSystemFontOfSize:26.0];
    ...
    _douyinNum.text = @"抖音号：";
    _douyinNum.textColor = [UIColor whiteColor];
    _douyinNum.font = [UIFont systemFontOfSize:12.0];
    ...
    [_github setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    _github.titleLabel.font = [UIFont systemFontOfSize:12.0];
    ...
    splitView.backgroundColor = RGBA(255.0, 255.0, 255.0, 0.2);
    ...
    _brief.textColor = RGBA(255.0, 255.0, 255.0, 0.6);
    _brief.font = [UIFont systemFontOfSize:12.0];
    ...
    _genderIcon.layer.backgroundColor = RGBA(255.0, 255.0, 255.0, 0.2).CGColor;
    ...
    _likeNum.font = [UIFont boldSystemFontOfSize:16.0];
    ...
    _followNum.text = @"0关注";
    _followNum.textColor = [UIColor whiteColor];
    _followNum.font = [UIFont boldSystemFontOfSize:16.0];
    ...
    _followedNum.textColor = [UIColor whiteColor];
...
- (void)scrollToTopAction:(CGFloat) offsetY {
    CGFloat alphaRatio = offsetY/(370.0f - 44 - [YBFrameTool statusBarHeight]);
