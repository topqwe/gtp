...
#define kSDWeiXinOnlyPhotoWidth 150
//+30
#define kSDWeiXinMultiPhotosWidth (MAINSCREEN_WIDTH > 320 ? 110 : 100)
//+30
#define kSDWeiXinMultiPhotosMargin 10
//+5
...
- (void)setPicPathStringsArray:(NSArray *)picPathStringsArray
{
    ...
    CGFloat margin = kSDWeiXinMultiPhotosMargin;
...
{
    if (array.count == 1) {
        return kSDWeiXinOnlyPhotoWidth;
    } else {
        if (_customImgWidth != 0) {
            return _customImgWidth;
        }else{
            CGFloat w = kSDWeiXinMultiPhotosWidth;
            return w;
        }
    }
}
...
{
    CGFloat itemW = picPathStringsArray.count == 1 ?  kSDWeiXinOnlyPhotoWidth : kSDWeiXinMultiPhotosWidth;
    CGFloat itemH = 0;
