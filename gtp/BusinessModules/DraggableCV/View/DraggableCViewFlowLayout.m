...
@interface UICollectionViewCell (DraggableCViewFlowLayout)

- (UIView *)LX_snapshotView;

@end

@implementation UICollectionViewCell (DraggableCViewFlowLayout)
...
@interface DraggableCViewFlowLayout ()
...
@implementation DraggableCViewFlowLayout
