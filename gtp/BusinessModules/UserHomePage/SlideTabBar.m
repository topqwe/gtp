...
-(void)layoutSubviews {
    ...
    [_titles enumerateObjectsUsingBlock:^(NSString * title, NSUInteger idx, BOOL *stop) {
        ...
        label.text = title;
        label.textColor = RGBA(255.0, 255.0, 255.0, 0.6);
        ...
        if(idx != self.titles.count - 1) {
            ...
            spliteLine.backgroundColor = RGBA(255.0, 255.0, 255.0, 0.2);
    ...
    _slideLightView.backgroundColor = YBGeneralColor.themeColor;
              ...
              initialSpringVelocity:0
                         ...
                         animations:^{
                             ...
                             [self.labels enumerateObjectsUsingBlock:^(UILabel *label, NSUInteger idx, BOOL *stop) {
                                 label.textColor = index == idx ? [UIColor whiteColor] : RGBA(255.0, 255.0, 255.0, 0.6);
                             }];
