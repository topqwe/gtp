...
-(NSString *)dsp
{
    ...
    YYTextContainer * container = [YYTextContainer containerWithSize:CGSizeMake(MAINSCREEN_WIDTH - 15 - 45 - 10 - 15, CGFLOAT_MAX)];
...
-(NSString *)content
{
    ...
    YYTextContainer * container = [YYTextContainer containerWithSize:CGSizeMake(MAINSCREEN_WIDTH - 2*15 , CGFLOAT_MAX)];
//    YYTextContainer * container = [YYTextContainer containerWithSize:CGSizeMake(MAINSCREEN_WIDTH - 15 - 45 - 10 - 15, CGFLOAT_MAX)];
